#!/bin/bash
GIST_URL='https://gist.githubusercontent.com/joshuacox/30c0b0871622b233195a8bb5229ee5e4/raw/9930d1e7329ebf4a5ef9c6d4009e20ce302dae29/gistfile1.txt'
sleep 1
wait_for_exist () {
  countzero=0
  while true; do
